// src/components/WholesalerSendReportModal.js
// Modal allowing user to select date range ("Is Hafte Ka", "Is Mahine Ka", "Custom Range"),
// generate Wholesaler PDF statement, and share via native OS share sheet or download locally.
...
export default function WholesalerSendReportModal({
  visible,
  onClose,
  wholesalerId,
  wholesalerName,
  ...
  const handleGenerate = async (mode) => {
    ...
    try {
      ...
      const localFileUri = await downloadWholesalerReportPdf(wholesalerId, start, end, wholesalerName);
      ...
      if (mode === 'share') {
        ...
        // 3. Open native share sheet (WhatsApp, Email, etc.)
        await Sharing.shareAsync(localFileUri, {
          mimeType: 'application/pdf',
          dialogTitle: `${wholesalerName} Ka Purchase Hisab Report`,
          UTI: 'com.adobe.pdf',
        });
      ...
      console.error('Wholesaler report error:', error);
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          ...
          <View style={styles.headerRow}>
            <View>
              <Text style={styles.modalTitle}>📄 Wholesaler Report (PDF)</Text>
              <Text style={styles.modalSubtitle}>Supplier: {wholesalerName}</Text>
            </View>
          ...
          {fixedDateRange ? (
            <View style={styles.fixedScopeBanner}>
              ...
              <Text style={styles.fixedScopeNote}>
                Sirf is selected arsay ki purchase & payment PDF report generate hogi.
              </Text>
            </View>
          ) : (
            <>
