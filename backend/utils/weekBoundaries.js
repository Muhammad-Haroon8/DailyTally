// backend/utils/weekBoundaries.js
 ...
 */
const parseYearMonth = (yearOrKey, month) => {
 ...
 * }>}
 */
const getWeeksInMonth = (yearOrMonthKey, monthNum) => {
 ...
 * @returns {Object|null}
 */
const findWeekForDay = (weeks, day) => {
 ...
 */
const getWeekFallback = (monthKeyOrYear, weekNum) => {
  try {
